//
//  SCLTFrameworkiOSTests.m
//  SCLTFrameworkiOSTests
//
//  Created by Fabrizio Duroni on 20/05/16.
...
@interface SCLTFrameworkiOSTests : XCTestCase

@end

@implementation SCLTFrameworkiOSTests
